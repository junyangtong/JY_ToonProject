Shader "JY/JYToon"// 暂时只支持forward
{
    Properties
    {
        ...
        [Toggle(_GLASS)] _Glass("Enable Glass Effect", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Shaders/ToonForwardPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.JYToonGUI"
}
